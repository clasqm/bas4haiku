...
install-po-yes:	$(CATALOGS)
		for cat in $(CATALOGS); do \
		  ...
		  /bin/install -c -m 644 $$cat $$dir/bas.mo; \
		done
...
install:	all
		/bin/install -c -m 755 -d ${exec_prefix}/bin
		/bin/install -c bas ${exec_prefix}/bin/bas
		/bin/install -c -m 755 -d ${exec_prefix}/lib
		/bin/install -c -m 644 libbas.a ${exec_prefix}/lib/libbas.a
		ranlib ${exec_prefix}/lib/libbas.a
		/bin/install -c -m 755 -d ${datarootdir}/man/man1
		/bin/install -c -m 644 bas.1 ${datarootdir}/man/man1/bas.1
		make install-po
